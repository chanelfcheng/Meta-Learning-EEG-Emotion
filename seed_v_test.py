...
def dataset_from_labels(features, labels, class_set): 
    ...
    return EEGDataset(features[class_mask], labels[class_mask].reshape((1,-1))[0])
...
class DCCA_AM(nn.Module):
    def __init__(self, input_size1, input_size2, layer_sizes1, layer_sizes2, outdim_size, categories, device):
        ...
        self.model1_parameters = list(self.model1.parameters()) # generator object
        self.model2_parameters = list(self.model1.parameters()) # generator object
...
class ProtoNet(pl.LightningModule):
    ...
    def calculate_prototypes(features, targets):
        ...
        features = features[0]
        # targets = targets.reshape((1,-1))[0] RESHAPED EARLIER IN get_all_data
