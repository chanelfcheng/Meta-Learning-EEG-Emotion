...
DATASET_PATH = "datasets/tutorial"
...
# ### References
# 
# [1] Snell, Jake, Kevin Swersky, and Richard S. Zemel. "Prototypical networks for few-shot learning." NeurIPS 2017. ([link](https://arxiv.org/pdf/1703.05175.pdf))
# 
# [2] Chelsea Finn, Pieter Abbeel, Sergey Levine. "Model-Agnostic Meta-Learning for Fast Adaptation of Deep Networks." ICML 2017. ([link](http://proceedings.mlr.press/v70/finn17a.html))
# 
# [3] Triantafillou, Eleni, Tyler Zhu, Vincent Dumoulin, Pascal Lamblin, Utku Evci, Kelvin Xu, Ross Goroshin et al. "Meta-dataset: A dataset of datasets for learning to learn from few examples." ICLR 2020. ([link](https://openreview.net/pdf?id=rkgAGAVKPr))
